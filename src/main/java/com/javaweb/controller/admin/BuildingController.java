...
public class BuildingController{
    ...
    public ModelAndView buildingList(@ModelAttribute BuildingSearchRequest buildingSearchRequest, HttpServletRequest request) {
        ...
        List<BuildingSearchResponse> responses = buildingService.findAll(buildingSearchRequest, PageRequest.of(buildingSearchRequest.getPage() - 1, buildingSearchRequest.getMaxPageItems()));
        model.setListResult(responses);
        model.setTotalItems(buildingService.countTotalItem(responses));
